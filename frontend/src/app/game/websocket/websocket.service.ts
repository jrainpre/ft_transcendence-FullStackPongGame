...
export class WebSocketService {
  ...
  privateLobby(modus: string | null, name: string | null, id_42: string | null, friend_socket_id: string | null, friend_name: string | null, friend_id_42: string | null){
    this.socket.emit('privateLobby', {player: this.socket.id, modus: modus, name: name, id_42: id_42, friend_socket_id: friend_socket_id, friend_name: friend_name, friend_id_42: friend_id_42});
  }
}